...
<!--MAINMENU AREA-->
    ...
    else
    {
        if(!empty($_POST) && $_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            $qry = mysqli_query ($con, "INSERT INTO parcels (name, email, tel, country, town, timee, datee, rname, remail, rtel, rcountry, rtown, message, tracking, status, rdatee) VALUES ('$name','$email','$tel','$country','$town' ,'$timee','$datee','$rname','$remail','$rtel','$rcountry','$rtown','$message', '$tracking','Unread','$rdatee')");
