...
<body class="single-page">
            ...
            <div class="row">
                <div class="col-md-12 col-xs-12">
                    <ul class="about-details-menu">
                        <li><a data-toggle="tab" href="#company">Parcels Sent</a></li>
                        <li class="active"><a data-toggle="tab" href="#history">Ticket</a></li>
	...
	if(!$con){
		...
		$qry =  "SELECT * FROM parcels where status = 'Unread'";
		$res = mysqli_query($con,$qry);
		if(mysqli_num_rows($res)>0){
			while ($row= mysqli_fetch_assoc($res)){
				echo "<center><br><br>Parcel Number: " .$row['id']." And Tracking Code ".$row['tracking']."<br> Sent By: ". $row['name']." Sent To: ". $row['rname']."<br> From ". $row['town']." To ". $row['rtown']." Was Sent on ". $row['datee']." ".$row['timee']." <br> And Message".$row['message']."</center><br><br> <hr>";
			}
		}
		else{
                        ...
                        <div id="history" class="company-history tab-pane fade in active">
                            <div class="row">
                                <div class="col-md-6 col-lg-8 col-sm-12 col-xs-12">
                                    <div class="about-history-content">
                                        <p><form action="parcel.php"  method="post">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                        <div class="form-group" id="name-field">
                                            <div class="form-input">
                                                <input type="text" class="form-control"  name="name" placeholder="Names.." required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                        <div class="form-group" id="email-field">
                                            <div class="form-input">
                                                <input type="text" class="form-control"  name="tracking" placeholder="Parcel Tracking No.." required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- end -->
                                 ...
                                 <div class="row">
                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                        <div class="form-group" id="name-field">
                                            <div class="form-input">
                                                <input type="text" class="form-control"  name="country" placeholder=" Sender Country.." required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                        <div class="form-group" id="email-field">
                                            <div class="form-input">
                                                <input type="text" class="form-control"  name="town" placeholder=" Sender Town /State.." required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- end -->
                                 ...
                                 <div class="row">
                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                        <div class="form-group" id="name-field">
                                            <div class="form-input">
                                                <input type="text" class="form-control"  name="timee" placeholder=" Time Sent.." required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                        <div class="form-group" id="email-field">
                                            <div class="form-input">
                                                <input type="text" class="form-control"  name="datee" placeholder=" Date Sent.." required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- end -->
                                <h3 style="color: red">RECEIVER INFOMATION</h3>
                                <div style="color: red">
                                ...
                                <div class="row" >
                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                        <div class="form-group" id="name-field">
                                            <div class="form-input">
                                                <input type="text" class="form-control"  name="rname" placeholder="Names.." required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                 ...
                                 <div class="row">
                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                        <div class="form-group" id="name-field">
                                            <div class="form-input">
                                                <input type="text" class="form-control"  name="rtel" placeholder="Telephone.." required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                        <div class="form-group" id="name-field">
                                            <div class="form-input">
                                                <input type="text" class="form-control"  name="rcountry" placeholder=" Reciever Country.." required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- end -->
                                 ...
                                 <div class="row">
                                   <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                        <div class="form-group" id="email-field">
                                            <div class="form-input">
                                                <input type="text" class="form-control"  name="rtown" placeholder=" Reciever Town /State.." required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                        <div class="form-group" id="email-field">
                                            <div class="form-input">
                                                <input type="text" class="form-control"  name="rdatee" placeholder=" Reciever Date.." required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                        <div class="form-group" id="message-field">
                                            <div class="form-input">
                                                <textarea class="form-control" rows="6"  name="message" placeholder="Parcel Description..." required></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-md-10 col-lg-10 col-md-offset-1 col-lg-offset-1 col-sm-12 col-xs-12 text-center">
                        <div class="promo-bottom-content wow fadeIn">
                            <h2>we provide international freight &amp; logistics service worldwide</h2>
